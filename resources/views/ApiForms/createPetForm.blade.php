<form action="/pet" method="POST" class="space-y-6">
    @csrf
    <h2 class="text-2xl font-semibold text-gray-700">Add a Pet</h2>
    ...
    <button type="submit" class="w-full py-3 text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition duration-200">Add Pet</button>
</form>